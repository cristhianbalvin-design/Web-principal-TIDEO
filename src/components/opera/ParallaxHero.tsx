...
export function ParallaxHero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background pt-20">
      {/* Parallax layers */}
      <div 
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10 text-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground">
          ...
          <span className="text-gradient">operación de activos intensivos</span>
        </h1>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          <HoverBorderGradient as="a" href="#arquitectura" containerClassName="rounded-full" className="px-8 py-3 text-sm md:text-base font-semibold bg-primary text-primary-foreground">
            Ver cómo funciona
          </HoverBorderGradient>
