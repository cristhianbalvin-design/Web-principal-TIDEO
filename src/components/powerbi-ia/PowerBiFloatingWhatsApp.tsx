...
export function PowerBiFloatingWhatsApp() {
  ...
  return (
    ...
    >
      {/* Tooltip / Label interactivo */}
      <div
        className={`hidden sm:flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-[#0b1320]/90 border border-[#25D366]/30 text-white text-xs font-medium shadow-xl backdrop-blur-md transition-all duration-300 pointer-events-none ${
      ...
      >
        ...
        <span>¿Dudas sobre el curso? Chatea con nosotros</span>
      </div>

      {/* Botón flotante circular con animación de pulso */}
      <a
        href={WA_URL}
        target="_blank"
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute -inset-1 rounded-full bg-[#25D366]/30 blur-sm group-hover:bg-[#25D366]/50 animate-pulse pointer-events-none"
        />
